...
COCO_CLASSES = ('sugar_box', 'large_marker', 'large_clamp', 'spoon',
                'sponge', 'pitcher_base', 'mustard_bottle', 'foam_brick',
                'extra_large_clamp', 'banana', 'tuna_fish_can', 'cracker_box',
                'scissors', 'potted_meat_can', 'tomato_soup_can', 'plate',
                'pudding_box', 'softball', 'bleach_cleanser', 'spatula',
                'bowl', 'mug', 'master_chef_can', 'wood_block', 'power_drill',
                'pear', 'gelatin_box')
...
coco_base_config = Config({
    ...
    'num_classes': 28, # This should include the background class
...
yolact_base_config = coco_base_config.copy({
    ...
    #'max_iter': 800000,
    'lr_steps': (35000, 75000, 85000, 91000),
    'max_iter': 100000,
