...
def postprocess(det_output, w, h, batch_idx=0, interpolation_mode='bilinear',
    ...
    if cfg.mask_type == mask_type.lincomb and cfg.eval_mask_branch:
        ...
        masks_map = masks_map.permute(2, 0, 1).contiguous()
        ...
        masks_map = F.interpolate(masks_map.unsqueeze(0), (h, w), mode=interpolation_mode, align_corners=False).squeeze(0)
        #print("masks_map", masks.shape)
        #print("masks_map", masks_map.shape)
        # Binarize the masks
        masks.gt_(0.5)
        #print(masks[0, 0, :7])
    ...
    if cfg.mask_type == mask_type.direct and cfg.eval_mask_branch:
        ...
        masks = full_masks
        print(masks[0, 0, :7])
    return classes, scores, boxes, masks, masks_map
